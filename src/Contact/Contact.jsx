            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 px-0 md:px-2 lg:px-0 gap-8 md:gap-0 lg:gap-8 items-start mx-auto lg:max-w-5xl">
                <div className="grid gap-2 text-light-400 ml-8 md:ml-0">
                    ...
                    <div className="flex items-center gap-3 text-lg">
                        ...
                        <h1 className="text-white">/in/taijulislammd/</h1>
                    </div>
                    <div className="flex items-center gap-3 text-lg">
                ...
                <div className=' lg:px-0 mx-4 lg:mx-0'>
                    <form ref={form} onSubmit={sendEmail} className="grid gap-10 p-3 lg:p-6 border">
                        <input className="py-2 lg:px-2 text-white transition-all border-b outline-none bg-[#010b1c] focus:border-accent-400" type="text" placeholder=" Name" name="from_name" />
                        <input className="py-2 lg:px-2 text-white transition-all border-b outline-none bg-[#010b1c] focus:border-accent-400" type="email" placeholder=" Email" name="from_email" />
