...
const Projects = () => {
    return (
        <div id="projects" className="mb-20 lg:max-w-6xl mx-auto">
            ...
            <div className="grid items-center grid-cols-1 gap-6 lg:grid-cols-2 justify-items-center">
                {/* Project One */}
                <div className="card w-[410px] lg:w-[450px] bg-[#2c1831] p-6 border rounded-lg shadow-2xl">
                    ...
                    <div className="mt-4 text-white">
                        ...
                        <div className="flex justify-between mt-7"><div className="flex flex-row mt-2">
                            ...
                            <a className="AllProject_btnProject__Yab7U btn rounded-[3px] out border-accent-400 bg-accent-400 hover:text-black font-semibold" href="/projectDetails/1"> Details</a>
                        </div>
                    </div>
                </div>
                {/* Project Two */}
